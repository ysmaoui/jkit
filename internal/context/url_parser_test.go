...
func TestParseJenkinsURL(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			url:       "https://jenkins.prod.com/blue/organizations/jenkins/PIPELINE_X%2Fproject-x/detail/develop/414/pipeline",
			wantHost:  "https://jenkins.prod.com",
			wantJob:   "PIPELINE_X/project-x/develop",
			wantBuild: 414,
		},
		{
			name:      "blue ocean multibranch with slash in branch",
			url:       "https://jenkins.prod.com/blue/organizations/jenkins/PIPELINE_TESTS%2Fproject-x/detail/JIRA-16917%2Frefactoring-static-buildnode/12/pipeline/97/",
			wantHost:  "https://jenkins.prod.com",
			wantJob:   "PIPELINE_TESTS/project-x/JIRA-16917%2Frefactoring-static-buildnode",
			wantBuild: 12,
		},
		{
			name:      "blue ocean deeply nested pipeline with last-component detail",
			url:       "https://jenkins.example.com/blue/organizations/jenkins/acme-sdk%2Fsystem-builds%2Ftemp%2F1234%2Fpkgs%2Fhelper-tool/detail/helper-tool/1/pipeline/11338/",
			wantHost:  "https://jenkins.example.com",
			wantJob:   "acme-sdk/system-builds/temp/1234/pkgs/helper-tool",
			wantBuild: 1,
		},
		{
		...
		// Branch names with slashes (encoded as %2F or double-encoded as %252F)
		{
			...
			url:       "https://jenkins.prod.com/job/PIPELINE/job/project-x/job/JIRA-16917%252Frefactoring/12/",
			wantHost:  "https://jenkins.prod.com",
			wantJob:   "PIPELINE/project-x/JIRA-16917%2Frefactoring",
			wantBuild: 12,
		},
		{
			name:      "branch with single-encoded slash (%2F)",
			url:       "https://jenkins.prod.com/job/PIPELINE/job/project-x/job/JIRA-16917%2Frefactoring/12/",
			wantHost:  "https://jenkins.prod.com",
			wantJob:   "PIPELINE/project-x/JIRA-16917%2Frefactoring",
			wantBuild: 12,
		},
